...
if input_file == "" :
    input_file = "../data/file_to_read.txt"
...
print("Output #145:")
inputPath = "/Users/jongbeomgo/PycharmProjects/Analytics/data" #sys.argv[1]
...
output_file = "../data/out.txt" #sys.argv[1]
...
output_file = "../data/append.txt" #sys.argv[1]
